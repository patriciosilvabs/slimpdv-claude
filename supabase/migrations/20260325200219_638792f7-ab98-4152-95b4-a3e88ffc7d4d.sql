  ...
  LOOP
    ...
    LOOP
      ...
      LOOP
        ...
        IF v_output_ingredient_id IS NOT NULL THEN
          -- GUARD: Skip if this ingredient is already linked directly to avoid double deduction
          IF NOT EXISTS (
            SELECT 1 FROM public.complement_option_ingredients coi
            WHERE coi.complement_option_id = extra_record.extra_id
              AND coi.ingredient_id = v_output_ingredient_id
    ...
    LOOP
      ...
      LOOP
        ...
        IF v_output_ingredient_id IS NOT NULL THEN
          ...
          IF NOT EXISTS (
            SELECT 1 FROM public.complement_option_ingredients coi
            WHERE coi.complement_option_id = sub_extra_record.option_id
              AND coi.ingredient_id = v_output_ingredient_id
              AND coi.tenant_id = order_record.tenant_id
          ) THEN
            SELECT i.id, i.current_stock, i.unit INTO ingredient_record
